...
let s:gb.bright_green   = ['#afd721', 142]     " 184-187-38
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:orange, s:none)
endif
...
call s:HL('StatusLine',   s:bg2, s:none)
call s:HL('StatusLineNC', s:bg1, s:none)
...
call s:HL('Folded', s:gb.green, s:bg1, s:italic)
...
if version >= 700
  ...
  call s:HL('Pmenu', s:blue, s:gb.dark0_hard)
  " Popup menu: selected item
  call s:HL('PmenuSel', s:bg2, s:blue, s:bold)
  " Popup menu: scrollbar
  call s:HL('PmenuSbar', s:none, s:gb.dark0_hard)
...
hi! link netrwDir GruvboxYellow
hi! link netrwClassify GruvboxYellow
...
hi! link NERDTreeDir GruvboxYellow
hi! link NERDTreeDirSlash GruvboxYellow
